...
def load_data(seq_len):
    ...
    # %%%%%%%%%%%% Num Of Req %%%%%%%%%%%%%%%%%%%%%%%
    result = []
    for index in range(len(req_values_normalize) - sequence_length):  ## looks like a moving avg !!!
            result.append(req_values_normalize[index: index + sequence_length])
    ...
    y_train_original_part = req_values_normalize[:int(row)]
