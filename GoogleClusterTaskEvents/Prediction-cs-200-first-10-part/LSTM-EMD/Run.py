...
if __name__=='__main__':
    ...
    imf_index=6
    X_train, y_train,y_train_original_part, X_test, y_test,ts_train,ts_test = Train_LSTM.load_data(imf_index,seq_len,mode)



    model = Train_LSTM.build_model([1, 50, 100,10, 1])
