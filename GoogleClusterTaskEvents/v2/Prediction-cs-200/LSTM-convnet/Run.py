...
def plot_results(predicted_data,ts_test, true_data,ts_train,y_train,rms,ms,map,meap,rmsre,mode):
    ...
    if mode == 1:
        plt.savefig(
            '/home/vacek/Cloud/cloud-predictor/GoogleClusterTaskEvents/v2/Prediction-cs-200/LSTM-convnet/results/Normalized_CPU' + '.png',
            dpi=700)
    elif mode == 2:
        plt.savefig(
            '/home/vacek/Cloud/cloud-predictor/GoogleClusterTaskEvents/v2/Prediction-cs-200/LSTM-convnet/results/Normalized_RAM' + '.png',
            dpi=700)
...
def plot_results_denormalize(predicted_data,ts_test, true_data,ts_train,y_train,rms,ms,map,meap,rmsre,mode):
    ...
    if mode == 1:
        plt.savefig(
            '/home/vacek/Cloud/cloud-predictor/GoogleClusterTaskEvents/v2/Prediction-cs-200/LSTM-convnet/results/Main_CPU' + '.png',
            dpi=700)
    elif mode == 2:
        plt.savefig(
            '/home/vacek/Cloud/cloud-predictor/GoogleClusterTaskEvents/v2/Prediction-cs-200/LSTM-convnet/results/Main_RAM' + '.png',
            dpi=700)
...
if __name__=='__main__':
    ...
    if mode == 1:
        plt.savefig(
            '/home/vacek/Cloud/cloud-predictor/GoogleClusterTaskEvents/v2/Prediction-cs-200/LSTM-convnet/results/Normalized_CPU_Train_Loss' + '.png',
            dpi=700)
    elif mode == 2:
        plt.savefig(
            '/home/vacek/Cloud/cloud-predictor/GoogleClusterTaskEvents/v2/Prediction-cs-200/LSTM-convnet/results/Normalized_RAM_Train_Loss' + '.png',
            dpi=700)
    plt.pause(3)
    plt.close()
