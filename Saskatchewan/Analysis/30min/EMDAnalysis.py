...
for imf_index in range(1,20):
    print(imf_index)
    cur0.execute('select ts,num_of_req from saskatchewan_http_emd_30min '
...
plt.xlabel('time symbol')
plt.ylabel('number of requests')
plt.savefig('/home/vacek/Cloud/cloud-predictor/Saskatchewan/prediction/1step/GANS-EMD/30min-smooth/resutls/Analysis'
