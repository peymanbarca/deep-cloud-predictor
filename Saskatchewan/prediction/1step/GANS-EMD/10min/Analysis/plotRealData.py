...
cur0.execute('select ts,num_of_req from saskatchewan_http_10min '
             ' '
             ' order by ts')
...
plt.savefig('/home/vacek/Cloud/cloud-predictor/Saskatchewan/prediction/GANS-EMD/10min/resutls/Analysis'
