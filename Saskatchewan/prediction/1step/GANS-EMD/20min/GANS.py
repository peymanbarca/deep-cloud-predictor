...
class GAN():
    ...
    def train(self, epochs,batchsize=128,verbose=False):
        ...
        plt.legend()
        plt.grid()
        plt.savefig('/home/vacek/Cloud/cloud-predictor/Saskatchewan/prediction/GANS-EMD/20min/resutls'
    ...
    def test(self):
        ...
        for k in range(len(ts_test)):
            ...
            cur.execute('update saskatchewan_http_emd_20min set num_req_pred_gan=%s where imf_index=%s'
