...
def plot_results(imf,predicted_data,ts_test, true_data,ts_train,y_train,ms,map,
    ...
    plt.legend()
    plt.grid()
    plt.savefig('/home/vacek/Cloud/cloud-predictor/NASA-HTTP/prediction/LSTM-EMD/5min/main/results/imf' + str(imf) + '/IMF_Original_' + str(imf) + '.png', dpi=900)
    plt.pause(3)
    plt.close()
...
if __name__=='__main__':
    for ii in range(1,17):
        ...
        plt.legend()
        plt.savefig('/home/vacek/Cloud/cloud-predictor/NASA-HTTP/prediction/LSTM-EMD/5min/main/results/imf' + str(
