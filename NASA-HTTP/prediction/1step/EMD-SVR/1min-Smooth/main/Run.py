...
for imf_index in range(1,21):
    ...
    plt.legend()
    plt.savefig('/home/vacek/Cloud/cloud-predictor/NASA-HTTP/prediction/EMD-SVR/1min-Smooth/main/results'
    ...
    def write_prediction_to_db(ts_test,y_pred,imf):
        ...
        for k in range(len(ts_test)):
            cur.execute('update nasa_http_emd_1min_copy set num_req_pred_svr=%s where imf_index=%s'
