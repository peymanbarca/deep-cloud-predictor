...
def mean_absolute_percentage_error(y_true, y_pred):
    ...
    plt.grid()
    plt.savefig('/home/vacek/Cloud/cloud-predictor/NASA-HTTP/prediction/GANS-EMD/1min-Smooth/resutls'
...
for i in imfs1:
    ...
    cur0.execute('select ts,num_of_req,num_req_pred_gan from nasa_http_emd_1min_copy where imf_index=%s'
    ...
    cur0.execute('select count(1) from nasa_http_emd_1min_copy where imf_index=1 and '
...
for j in imfs2:
    ...
    cur0.execute('select ts,num_of_req,num_req_pred_svr from nasa_http_emd_1min_copy where imf_index=%s'
