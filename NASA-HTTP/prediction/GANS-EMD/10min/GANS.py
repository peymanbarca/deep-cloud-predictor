...
class GAN():
    ...
    def test(self):
        ...
        for k in range(len(ts_test)):
            ...
            cur.execute('update nasa_http_emd_10min set num_req_pred_gan=%s where imf_index=%s'
...
if __name__ == '__main__':
    ...
    for imf_index in range(1,16):
        ...
        gan = GAN()
        gan.train(epochs=70,batchsize=32,verbose=False)
        gan.test()
