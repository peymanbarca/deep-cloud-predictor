...
for imf_index in range(1,13):
    ...
    plt.legend()
    plt.savefig('/home/vacek/Cloud/cloud-predictor/EPA-HTTP/prediction/EMD-SVR/5sec/main/results'
    ...
    def write_prediction_to_db(ts_test,y_pred,imf):
        ...
        for k in range(len(ts_test)):
            cur.execute('update epa_http_emd_5sec set num_req_pred_svr=%s where imf_index=%s'
