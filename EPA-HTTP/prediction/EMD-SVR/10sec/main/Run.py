...
for imf_index in range(1,15):
    ...
    plt.legend()
    plt.savefig('/home/vacek/Cloud/cloud-predictor/EPA-HTTP/prediction/EMD-SVR/10sec/main/results'
    ...
    def write_prediction_to_db(ts_test,y_pred,imf):
        ...
        for k in range(len(ts_test)):
            cur.execute('update epa_http_emd_10sec set num_req_pred_svr=%s where imf_index=%s'
